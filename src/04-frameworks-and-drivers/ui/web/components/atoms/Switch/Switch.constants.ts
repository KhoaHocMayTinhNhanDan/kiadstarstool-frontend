// src/04-frameworks-and-drivers/ui/web/components/atoms/Switch/Switch.constants.ts

// ===== VARIANT CONFIGURATION =====
export const SWITCH_VARIANTS = ['default', 'primary', 'secondary'] as const;

export type SwitchVariant = typeof SWITCH_VARIANTS[number];

export const SWITCH_VARIANT_CONFIG: Record<SwitchVariant, {
...
// ===== SIZE CONFIGURATION =====
export const SWITCH_SIZES = ['xs', 'sm', 'md', 'lg', 'xl'] as const;

export type SwitchSize = typeof SWITCH_SIZES[number];

export const SWITCH_SIZE_CONFIG: Record<SwitchSize, {
...
export const SWITCH_CONFIG = {
  ...
  // Variant styles
  variantStyles: SWITCH_VARIANT_CONFIG,
  
  // Size styles
  sizeStyles: SWITCH_SIZE_CONFIG,
  ...
  // Helper functions
  getVariantStyle(variant: SwitchVariant) {
    return this.variantStyles[variant];
  },
  
  getSizeStyle(size: SwitchSize) {
...
// ===== I18N KEYS =====
export const SWITCH_I18N_KEYS = {
  defaultLabel: 'switch.defaultLabel',
  altText: 'switch.altText',
  ariaLabel: 'switch.ariaLabel',
  clickMessage: 'switch.clickMessage',
  loadingText: 'switch.loadingText',
} as const;
