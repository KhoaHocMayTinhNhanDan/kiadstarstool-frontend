...
A highly configurable switch component with variants, sizes, status indicators, and i18n support.
...
## Installation
```bash
npm run generate:atom Switch
```

## Usage
```tsx
import { Switch, SwitchWithStatus, SwitchGroup } from './components/atoms/Switch';
...
export const SWITCH_VARIANT_CONFIG = {
  // ... existing variants
  success: { // 👈 Add config
    color: '#ffffff',
    bgColor: '#10b981',
...
```typescript
// en.ts
'switch.defaultLabel': 'Switch',
'switch.altText': 'Switch',
'switch.ariaLabel': 'Switch',
'switch.clickMessage': 'Switch clicked!',
'switch.loadingText': 'Loading...',

// vi.ts
'switch.defaultLabel': 'Switch',
'switch.altText': 'Switch',
'switch.ariaLabel': 'Switch',
'switch.clickMessage': 'Đã nhấn Switch!',
'switch.loadingText': 'Đang tải...',
```
