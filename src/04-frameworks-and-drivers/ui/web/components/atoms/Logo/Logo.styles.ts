// src/04-frameworks-and-drivers/ui/web/components/atoms/Logo/Logo.styles.ts
import styled, { css } from 'styled-components';
import type { LogoVariant, LogoSize } from './Logo.constants';
...
export const LoadingSpinner = styled.div<{ $size: LogoSize }>`
  @keyframes spin {
