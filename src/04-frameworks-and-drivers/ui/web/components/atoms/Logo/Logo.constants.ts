// src/04-frameworks-and-drivers/ui/web/components/atoms/Logo/Logo.constants.ts

// ===== VARIANT CONFIGURATION =====
export const LOGO_VARIANTS = ['default', 'primary', 'secondary'] as const;

export type LogoVariant = typeof LOGO_VARIANTS[number];

export const LOGO_VARIANT_CONFIG: Record<LogoVariant, {
...
// ===== SIZE CONFIGURATION =====
export const LOGO_SIZES = ['xs', 'sm', 'md', 'lg', 'xl'] as const;

export type LogoSize = typeof LOGO_SIZES[number];

export const LOGO_SIZE_CONFIG: Record<LogoSize, {
...
export const LOGO_CONFIG = {
  ...
  // Variant styles
  variantStyles: LOGO_VARIANT_CONFIG,
  
  // Size styles
  sizeStyles: LOGO_SIZE_CONFIG,
  
  // Default values
  defaults: {
    variant: 'default' as LogoVariant,
    size: 'md' as LogoSize,
  },
  
  // Helper functions
  getVariantStyle(variant: LogoVariant) {
    return this.variantStyles[variant];
  },
  
  getSizeStyle(size: LogoSize) {
...
// ===== I18N KEYS =====
export const LOGO_I18N_KEYS = {
  defaultLabel: 'logo.defaultLabel',
  altText: 'logo.altText',
  ariaLabel: 'logo.ariaLabel',
  clickMessage: 'logo.clickMessage',
  loadingText: 'logo.loadingText',
} as const;
