// src/04-frameworks-and-drivers/ui/web/components/atoms/Progress/Progress.styles.ts
import styled, { css } from 'styled-components';
import type { ProgressVariant, ProgressSize } from './Progress.constants';
...
export const LoadingSpinner = styled.div<{ $size: ProgressSize }>`
  @keyframes spin {
