// src/04-frameworks-and-drivers/ui/web/components/atoms/Radio/Radio.constants.ts

// ===== VARIANT CONFIGURATION =====
export const RADIO_VARIANTS = ['default', 'primary', 'secondary'] as const;

export type RadioVariant = typeof RADIO_VARIANTS[number];

export const RADIO_VARIANT_CONFIG: Record<RadioVariant, {
...
export const RADIO_SIZE_CONFIG: Record<RadioSize, {
...
export const RADIO_CONFIG = {
  ...
  // Variant styles
  variantStyles: RADIO_VARIANT_CONFIG,
  
  // Size styles
  sizeStyles: RADIO_SIZE_CONFIG,
  ...
  // Helper functions
  getVariantStyle(variant: RadioVariant) {
    return this.variantStyles[variant];
  },
  
  getSizeStyle(size: RadioSize) {
...
// ===== I18N KEYS =====
export const RADIO_I18N_KEYS = {
  defaultLabel: 'radio.defaultLabel',
  altText: 'radio.altText',
  ariaLabel: 'radio.ariaLabel',
  clickMessage: 'radio.clickMessage',
  loadingText: 'radio.loadingText',
} as const;
