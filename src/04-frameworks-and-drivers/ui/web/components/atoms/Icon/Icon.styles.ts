// src/04-frameworks-and-drivers/ui/web/components/atoms/Icon/Icon.styles.ts
import styled, { css } from 'styled-components';
import type { IconVariant, IconSize } from './Icon.constants';
...
export const LoadingSpinner = styled.div<{ $size: IconSize }>`
  @keyframes spin {
