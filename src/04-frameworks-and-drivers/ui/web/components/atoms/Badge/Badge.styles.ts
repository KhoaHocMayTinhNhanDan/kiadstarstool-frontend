// src/04-frameworks-and-drivers/ui/web/components/atoms/Badge/Badge.styles.ts
import styled, { css } from 'styled-components';
import type { BadgeVariant, BadgeSize } from './Badge.constants';
...
export const LoadingSpinner = styled.div<{ $size: BadgeSize }>`
  @keyframes spin {
